...
export default function Controls({ initialScale, setScale, setShowScaleNumbers })
{
    ...
    function onScaleNumberCheckboxToggle(event)
    {
        const checked = event.target.checked;
        setShowScaleNumbers(checked);
    }
        ...
        <div id={"controls"}>
            ...
            <div className={"control-section"}>
                <div id={"volume-control-row"} className={"control-row"}>
                    ...
                    <input id={"volume-range"} type={"range"} min={0} max={100} defaultValue={75} step={1}
            ...
            <div className={"control-section"}>
                <div id={"play-button-control-row"} className={"control-row"}>
                    <button className={"action-button"} id={"play-button"} onClick={onPlayButtonClick}>Play Scale
                    </button>
                </div>
            </div>
        </div>
